...
extension LiveKeychain {
  fileprivate static func genericPasswordQueryDictionary(account: String, service: String) -> [String: Any] {
    [
  ...
  fileprivate static func keyQueryDictionary(applicationTag: String) -> [String: Any] {
    [
