...
A free, open-source iOS client for [Mastodon](https://joinmastodon.org/), [Glitch-Soc](https://glitch-soc.github.io/docs/), [GoToSocial](https://gotosocial.org/), [Firefish](https://codeberg.org/firefish/firefish), [Akkoma](https://akkoma.social/), and other Mastodon-API-compatible Fediverse instance servers.
