...
extension HTML {
  ...
  public enum LinkClass: Int, Codable {
...
extension AttributeScopes {
  public var feditext: FeditextAttributes.Type {
    FeditextAttributes.self
  }
  public var all: AllAttributes.Type {
    AllAttributes.self
  }
}
...
extension AttributeScopes {
  ...
  public struct AllAttributes: AttributeScope {
...
extension HTML {
  ...
  fileprivate static let attributedStringCache = NSCache<NSString, AttributedStringCacheValue>()
  ...
  fileprivate static func parse(_ raw: String) -> AttributedString {
    #if DEBUG
  ...
  fileprivate static func mapSirenAttrsToFeditextAttrs(_ attrStr: inout AttributedString) {
  ...
  fileprivate static func rewriteLinks(_ attrStr: inout AttributedString) {
