...
extension PrefsLanguage {
  ...
  public static func languageTagsAndNames(prefsLanguageTag: PrefsLanguage.Tag?) -> [PrefsLanguage] {
    ...
    for identifier in systemIdentifiers {
      guard let prefsLanguage = Self(Locale(identifier: identifier)),
        !tags.contains(prefsLanguage.id)
      else {
        continue
      }
  ...
  public static func preferredLanguageTagsAndNames(prefsLanguageTag: PrefsLanguage.Tag?) -> [PrefsLanguage] {
    var list: [PrefsLanguage] = []
    var tags: Set<PrefsLanguage.Tag> = Set()
...
extension PrefsLanguage {
  ...
  fileprivate static func reducedLanguageTag(_ locale: Locale) -> PrefsLanguage.Tag? {
    if #available(iOS 16, *) {
  ...
  fileprivate static func localizedStringExtended(forIdentifier identifier: String) -> String {
  ...
  fileprivate static var extendedLanguageTagsAndLocalizedStrings: [String: String] {
    [
