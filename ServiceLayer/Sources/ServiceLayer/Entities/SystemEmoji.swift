...
extension SystemEmoji {
  public enum Group: Int, Codable, Hashable, CaseIterable {
  ...
  public enum SkinTone: Int, Codable, Hashable, CaseIterable {
    case light = 1
    case mediumLight = 2
    case medium = 3
    case mediumDark = 4
  ...
  public func withMaxVersionForSkinToneVariations(_ version: Float) -> Self {
    Self(from: self, maxVersionForSkinToneVariations: version)
  }

  public func applying(skinTone: SkinTone) -> SystemEmoji {
