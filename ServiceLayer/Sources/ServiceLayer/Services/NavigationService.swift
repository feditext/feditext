...
extension NavigationService {
  ...
  public func lookup(url: URL, identityId: Identity.Id) -> AnyPublisher<Navigation, Never> {
  ...
  public func notificationService(notification: MastodonNotification) -> NotificationService {
    NotificationService(
  ...
  public func conversationService(conversation: Conversation) -> ConversationService {
    ConversationService(
  ...
  public func editProfile() -> Navigation? {
    let url: URL
  ...
  public func accountSettings() -> Navigation? {
    let url: URL
    switch mastodonAPIClient.apiCapabilities.flavor {
    case nil:
      return nil
