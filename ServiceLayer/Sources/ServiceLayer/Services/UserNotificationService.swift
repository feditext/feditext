...
extension UserNotificationService {
  public typealias Event = UserNotificationClient.DelegateEvent
  public typealias Content = UNNotificationContent
  public typealias MutableContent = UNMutableNotificationContent
  public typealias Trigger = UNNotificationTrigger
  public typealias Request = UNNotificationRequest

  public func isAuthorized(request: Bool) -> AnyPublisher<Bool, Error> {
  ...
  public func add(request: Request) -> AnyPublisher<Never, Error> {
...
extension UserNotificationService {
  fileprivate func getNotificationSettings() -> AnyPublisher<UNNotificationSettings, Never> {
  ...
  fileprivate func requestAuthorization() -> AnyPublisher<Bool, Error> {
