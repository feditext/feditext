...
public struct AllIdentitiesService {
  ...
  public init(environment: AppEnvironment) throws {
    ...
    self.database =
      try environment.fixtureDatabase
      ?? IdentityDatabase(
...
extension AllIdentitiesService {
  public enum IdentityCreation {
    case authentication
    case registration(Registration)
    case browsing
  }

  public func identityService(id: Identity.Id) throws -> IdentityService {
  ...
  public func createIdentity(url: URL, kind: IdentityCreation) -> AnyPublisher<Never, Error> {
    ...
    let authenticationServicePublisher =
      apiCapabilitiesPublisher
    ...
    case .authentication:
      authenticationPublisher =
        authenticationServicePublisher
  ...
  public func updatePushSubscriptions(deviceToken: Data) -> AnyPublisher<Never, Error> {
...
extension AllIdentitiesService.IdentityCreation {
