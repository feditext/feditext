...
extension IdentityService {
  public var apiCapabilities: APICapabilities { secrets.getAPICapabilities() }

  public func refreshAPICapabilities() -> AnyPublisher<Never, Error> {
    APICapabilities
      .refresh(
        session: environment.session,
  ...
  public func updateLastUse() -> AnyPublisher<Never, Error> {
    identityDatabase.updateLastUsedAt(id: id)
  }

  public func verifyCredentials() -> AnyPublisher<Never, Error> {
  ...
  public func refreshServerPreferences() -> AnyPublisher<Never, Error> {
    mastodonAPIClient.request(PreferencesEndpoint.preferences)
      .flatMap { identityDatabase.updatePreferences($0, id: id) }
      .eraseToAnyPublisher()
  }

  public func refreshInstance() -> AnyPublisher<Never, Error> {
  ...
  public func instanceServicePublisher() -> AnyPublisher<InstanceService, Error> {
    contentDatabase.instancePublisher()
      .map { InstanceService(instance: $0, mastodonAPIClient: mastodonAPIClient) }
      .eraseToAnyPublisher()
  }

  public func refreshEmojis() -> AnyPublisher<Never, Error> {
    mastodonAPIClient.request(EmojisEndpoint.customEmojis)
      .flatMap(contentDatabase.update(emojis:))
      .eraseToAnyPublisher()
  }

  public func refreshAnnouncements() -> AnyPublisher<Never, Error> {
    announcementsService().request(maxId: nil, minId: nil)
  }

  public func refreshRules() -> AnyPublisher<Never, Error> {
    mastodonAPIClient.request(RulesEndpoint.rules)
      .flatMap(contentDatabase.update(rules:))
      .eraseToAnyPublisher()
  }

  public func confirmIdentity() -> AnyPublisher<Never, Error> {
    identityDatabase.confirmIdentity(id: id)
  }

  public func identitiesPublisher() -> AnyPublisher<[Identity], Error> {
    identityDatabase.identitiesPublisher()
  }

  public func recentIdentitiesPublisher() -> AnyPublisher<[Identity], Error> {
    identityDatabase.recentIdentitiesPublisher(excluding: id)
  }

  public func otherAuthenticatedIdentitiesPublisher() -> AnyPublisher<[Identity], Error> {
    identityDatabase.authenticatedIdentitiesPublisher(excluding: id)
  }

  public func refreshLists() -> AnyPublisher<Never, Error> {
  ...
  public func updateList(_ list: List) -> AnyPublisher<List, Error> {
    mastodonAPIClient.request(
      ListEndpoint.update(
        id: list.id,
        title: list.title,
  ...
  public func requestRelationships(ids: Set<Account.Id>) -> AnyPublisher<Never, Error> {
    mastodonAPIClient.request(RelationshipsEndpoint.relationships(ids: Array(ids)))
      .flatMap(contentDatabase.insert(relationships:))
      .eraseToAnyPublisher()
  }

  public func requestFamiliarFollowers(ids: Set<Account.Id>) -> AnyPublisher<Never, Error> {
  ...
  public func getLocalLastReadId(timeline: Timeline) -> String? {
    contentDatabase.lastReadId(timelineId: timeline.id)
  }

  public func setLocalLastReadId(_ id: String, timeline: Timeline) -> AnyPublisher<Never, Error> {
    contentDatabase.setLastReadId(id, timelineId: timeline.id)
  }

  public func identityPublisher(immediate: Bool) -> AnyPublisher<Identity, Error> {
  ...
  public func updateFilter(_ filter: Filter) -> AnyPublisher<Never, Error> {
    mastodonAPIClient.request(
      FilterEndpoint.update(
        id: filter.id,
        phrase: filter.phrase,
        context: filter.context,
        irreversible: filter.irreversible,
  ...
  public func activeFiltersPublisher() -> AnyPublisher<[Filter], Error> {
  ...
  public func followTag(name: Tag.Name) -> AnyPublisher<Tag, Error> {
    mastodonAPIClient.request(TagEndpoint.follow(name: name))
      .andAlso { contentDatabase.createFollowedTag(FollowedTag($0)) }
  }

  public func unfollowTag(name: Tag.Name) -> AnyPublisher<Tag, Error> {
  ...
  public func getTag(name: Tag.Name) -> AnyPublisher<Tag, Error> {
  ...
  public func updatePreferences(_ preferences: Identity.Preferences, authenticated: Bool) -> AnyPublisher<Never, Error>
  {
  ...
  public func post(statusComponents: StatusComponents) -> AnyPublisher<Status.Id, Error> {
    mastodonAPIClient.request(StatusEndpoint.post(statusComponents)).map(\.id).eraseToAnyPublisher()
  }

  public func put(id: Status.ID, statusComponents: StatusComponents) -> AnyPublisher<Status.Id, Error> {
    mastodonAPIClient.request(StatusEndpoint.put(id: id, statusComponents)).map(\.id).eraseToAnyPublisher()
  }

  public func notificationService(pushNotification: PushNotification) -> AnyPublisher<NotificationService, Error> {
  ...
  public func service(accountList: AccountsEndpoint, titleComponents: [String]? = nil) -> AccountListService {
    AccountListService(
  ...
  public func suggestedAccountListService(titleComponents: [String]? = nil) -> SuggestedAccountListService {
  ...
  public func conversationsService() -> ConversationsService {
  ...
  public func announcementsService() -> AnnouncementsService {
...
extension IdentityService {
  #if DEBUG
    fileprivate static let pushSubscriptionEndpointURL = URL(string: "https://apns.feditext.com/push?sandbox=true")!
  #else
    fileprivate static let pushSubscriptionEndpointURL = URL(string: "https://apns.feditext.com/push")!
  #endif
}
