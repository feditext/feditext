...
extension MediaProcessingService {
  ...
  public static func description(itemProvider: NSItemProvider) -> AnyPublisher<String?, Never> {
    let registeredTypes = itemProvider.registeredTypeIdentifiers.compactMap(UTType.init)
...
extension MediaProcessingService {
  ...
  fileprivate static let uploadableMimeTypes = Set(
    [
      UTType.png,
      UTType.jpeg,
      UTType.gif,
  ...
  fileprivate static func fileRepresentationDataPublisher(
  ...
  fileprivate static func imageData(url: URL, type: UTType) throws -> Data {
  ...
  fileprivate static func loadFileRepresentation(
  ...
  fileprivate static func imageDescription(url: URL) throws -> String? {
    ...
    guard
      let imageProperties: NSDictionary = CGImageSourceCopyPropertiesAtIndex(
        imageSource,
        primaryImageIndex,
        nil
      )
  ...
  fileprivate static func avDescription(url: URL) async throws -> String? {
  ...
  fileprivate static func withTempCopy<P>(
    _ url: URL,
