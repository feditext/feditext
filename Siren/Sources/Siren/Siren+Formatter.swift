...
extension Siren {
  ...
  public static func format(_ attrStr: inout AttributedString, descriptor: CTFontDescriptor, baseIndent: CGFloat) {
  ...
  private enum ListType {
  ...
  #if canImport(UIKit)
    public static func format(_ attributed: inout AttributedString, textStyle: UIFont.TextStyle, baseIndent: CGFloat) {
      format(
        &attributed,
    ...
    #endif
  #elseif canImport(AppKit)
    public static func format(_ attributed: inout AttributedString, textStyle: NSFont.TextStyle, baseIndent: CGFloat) {
      format(
        &attributed,
