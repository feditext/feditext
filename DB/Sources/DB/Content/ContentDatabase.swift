...
extension ContentDatabase {
  public static func delete(id: Identity.Id, appGroup: String) throws {
  ...
  public func cleanHomeTimelinePublisher() -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func insert(context: Context, parentId: Status.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func insert(pinnedStatuses: [Status], accountId: Account.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func toggleShowContent(id: Status.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      if let toggle =
  ...
  public func toggleShowAttachments(id: Status.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      if let toggle =
  ...
  public func toggleShowFiltered(id: Status.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      if let toggle =
        try StatusShowFilteredToggle
  ...
  public func update(id: Status.Id, poll: Poll) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func update(id: Status.Id, source: StatusSource) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      try StatusRecord
  ...
  public func delete(id: Status.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher(updates: StatusRecord.filter(StatusRecord.Columns.id == id).deleteAll)
  }

  public func unfollow(id: Account.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func mute(id: Account.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func block(id: Account.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher(updates: AccountRecord.filter(AccountRecord.Columns.id == id).deleteAll)
  }

  public func insert(accounts: [Account], listId: AccountList.Id? = nil) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      var order: Int?
  ...
  public func insert(identityProofs: [IdentityProof], id: Account.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func insert(featuredTags: [FeaturedTag], id: Account.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func insert(relationships: [Relationship]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func insert(familiarFollowers: [FamiliarFollowers]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      for followedAccount in familiarFollowers {
        ...
        try FamiliarFollowersJoin
          .filter(
            FamiliarFollowersJoin.Columns.followedAccountId == followedAccount.id
  ...
  public func setLists(_ lists: [List]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      for list in lists {
      ...
      try TimelineRecord
        .filter(
          !lists.map(\.id).contains(TimelineRecord.Columns.listId)
  ...
  public func createList(_ list: List) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher { try TimelineRecord(timeline: Timeline.list(list)).save($0) }
  }

  public func updateList(_ list: List) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      try TimelineRecord
  ...
  public func deleteList(id: List.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher(updates: TimelineRecord.filter(TimelineRecord.Columns.listId == id).deleteAll)
  }

  public func setFilters(_ filters: [Filter]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func deleteFilter(id: Filter.Id) -> AnyPublisher<Never, Error> {
  ...
  public func setLastReadId(_ id: String, timelineId: Timeline.Id) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher { try LastReadIdRecord(timelineId: timelineId, id: id).save($0) }
  }

  public func insert(notifications: [MastodonNotification]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func insert(conversations: [Conversation]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func update(instance: Instance) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      try instance.save($0)
  ...
  public func update(emojis: [Emoji]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
      for emoji in emojis {
        try emoji.save($0)
      }
  ...
  public func updateUse(emoji: String, system: Bool) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func update(announcements: [Announcement]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func update(rules: [Rule]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func update(suggestions: [Suggestion]) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher { db in
  ...
  public func insert(results: Results) -> AnyPublisher<Never, Error> {
    databaseWriter.mutatingPublisher {
  ...
  public func timelinePublisher(_ timeline: Timeline, applyV1Filters: Bool) -> AnyPublisher<[CollectionSection], Error>
  {
    ValueObservation.tracking(
  ...
  public func contextPublisher(id: Status.Id, applyV1Filters: Bool) -> AnyPublisher<[CollectionSection], Error> {
    ValueObservation.tracking(
  ...
  public func accountListPublisher(
    id: AccountList.Id,
  ...
  public func listsPublisher() -> AnyPublisher<[Timeline], Error> {
    ValueObservation.tracking(
      TimelineRecord.filter(TimelineRecord.Columns.listId != nil)
  ...
  public func followedTagsPublisher() -> AnyPublisher<[FollowedTag], Error> {
  ...
  public func profilePublisher(id: Account.Id) -> AnyPublisher<Profile, Error> {
  ...
  public func relationshipPublisher(id: Account.Id) -> AnyPublisher<Relationship, Error> {
  ...
  public func publisher(results: Results, limit: Int?) -> AnyPublisher<[CollectionSection], Error> {
  ...
  public func notificationsPublisher(
  ...
  public func conversationsPublisher() -> AnyPublisher<[Conversation], Error> {
  ...
  public func instancePublisher() -> AnyPublisher<Instance, Error> {
    ValueObservation.tracking(
  ...
  public func announcementCountPublisher() -> AnyPublisher<(total: Int, unread: Int), Error> {
    ValueObservation.tracking(Announcement.fetchCount)
      .removeDuplicates()
      .publisher(in: databaseWriter)
      .combineLatest(
        ValueObservation.tracking(Announcement.filter(Announcement.Columns.read == false).fetchCount)
          .removeDuplicates()
          .publisher(in: databaseWriter)
      )
  ...
  public func announcementsPublisher() -> AnyPublisher<[CollectionSection], Error> {
  ...
  public func pickerEmojisPublisher() -> AnyPublisher<[Emoji], Error> {
    ValueObservation.tracking(
  ...
  public func emojiUses(limit: Int) -> AnyPublisher<[EmojiUse], Error> {
    databaseWriter.readPublisher(value: EmojiUse.all().order(EmojiUse.Columns.count.desc).limit(limit).fetchAll)
      .eraseToAnyPublisher()
  }

  public func rulesPublisher() -> AnyPublisher<[Rule], Error> {
  ...
  public func lastReadId(timelineId: Timeline.Id) -> String? {
  ...
  public func lookup(accountURL url: URL) -> AnyPublisher<Account.Id, Error> {
    databaseWriter
      .readPublisher(
        value:
          AccountRecord
  ...
  /// Returns up to one ID.
  public func lookup(statusURL url: URL) -> AnyPublisher<Status.Id, Error> {
  ...
  /// Returns up to one ID.
  public func lookup(url: URL) -> AnyPublisher<URLLookupResult, Error> {
  ...
  public func catchNotFound<Output>(_ failure: Error) -> AnyPublisher<Output, Error> {
    let failurePublisher = Fail(outputType: Output.self, failure: failure)

    if let error = failure as? SpecialCaseError,
      case .notFound(let what) = error.specialCase
    {
      return delete(what)
        .andThen {
          failurePublisher
  ...
  public func displayFilterPublisher(_ timeline: Timeline) -> AnyPublisher<DisplayFilter, Error> {
  ...
  public func update(_ timeline: Timeline, _ displayFilter: DisplayFilter) -> AnyPublisher<Never, Error> {
    guard timeline.hasDisplayFilter else {
...
extension ContentDatabase {
  fileprivate static let cleanAfterLastReadIdCount = 40
  fileprivate static let ephemeralTimelines = NSCountedSet()

  fileprivate static func fileURL(id: Identity.Id, appGroup: String) throws -> URL {
    try FileManager.default.databaseDirectoryURL(name: id.uuidString, appGroup: appGroup)
  }

  fileprivate static func statusIdsToDeleteForPositionPreservingClean(db: Database) throws -> Set<Status.Id> {
  ...
  fileprivate static func accountIdsToDeleteForPositionPreservingClean(db: Database) throws -> Set<Account.Id> {
    var accountIdsToKeep = try Account.Id.fetchSet(db, StatusRecord.select(StatusRecord.Columns.accountId))
    accountIdsToKeep.formUnion(
      try Account.Id.fetchSet(
        db,
        AccountRecord.filter(
