...
extension EditAttachmentViewController {
  fileprivate enum TextDetectionOutput {
  ...
  fileprivate func detectText(cgImage: CGImage) -> AnyPublisher<TextDetectionOutput, Error> {
