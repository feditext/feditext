...
final class NotificationService: UNNotificationServiceExtension {
  ...
  override func didReceive(
    ...
    if appPreferences.notificationAccountName,
      case .success(let handle) = parsingService.handle(identityId: identityId)
    {
    ...
    Self.attachment(imageURL: imageURL)
      ...
      .zip(
        parsingService.title(pushNotification: pushNotification, identityId: identityId)
...
extension NotificationService {
  ...
  fileprivate static func attachment(imageURL: URL) -> AnyPublisher<UNNotificationAttachment, Error> {
