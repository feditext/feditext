...
final class IdentitiesDataSource: UITableViewDiffableDataSource<IdentitiesSection, IdentitiesItem> {
  ...
  override func apply(
    _ snapshot: NSDiffableDataSourceSnapshot<IdentitiesSection, IdentitiesItem>,
  ...
  override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
    ...
    if currentSnapshot.numberOfItems(inSection: section) > 0, case .identities(let title) = section {
      return title
    }
...
extension IdentitiesDataSource {
