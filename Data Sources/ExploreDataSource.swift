...
final class ExploreDataSource: UICollectionViewDiffableDataSource<ExploreViewModel.Section, ExploreViewModel.Item> {
  ...
  override func apply(
    _ snapshot: NSDiffableDataSourceSnapshot<ExploreViewModel.Section, ExploreViewModel.Item>,
...
extension ExploreViewModel.Section {
  fileprivate func displayName(_ statusWord: AppPreferences.StatusWord) -> String {
    switch self {
    case .tags:
