...
struct AppPreferencesSection: View {
  ...
  var body: some View {
    Section(header: Text("preferences.app")) {
      ...
      Group {
        Picker(
          "preferences.media.autoplay.gifs",
        ...
        Picker(
          "preferences.media.autoplay.videos",
        ...
        Picker(
          "preferences.media.avatars.animate",
      ...
      {
        Picker(
          "preferences.home-timeline-position-on-startup",
    ...
    Section(header: Text("preferences.app.advanced")) {
      Picker(
        "preferences.api-compatibility-mode",
        selection: Binding<APICompatibilityMode?>(
