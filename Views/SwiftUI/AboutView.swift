...
extension AboutView {
  fileprivate static let officialAccountURL = URL(string: "https://mastodon.social/@Feditext")!
  fileprivate static let projectWebsiteURL = URL(string: "https://www.feditext.com/")!
  fileprivate static let sourceCodeAndIssueTrackerURL = AppUrl.website

  fileprivate struct Maintainer: Identifiable {
    let name: String
    let emoji: String
    let url: URL
  ...
  fileprivate static let maintainers: [Maintainer] = [
  ...
  fileprivate static let metabolistWebsiteURL = URL(string: "https://metabolist.org")!
  ...
  fileprivate static var build: String {
