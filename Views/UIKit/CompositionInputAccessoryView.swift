...
extension CompositionInputAccessoryView: UICollectionViewDelegate {
  ...
  func collectionView(
    ...
    guard let item = autocompleteDataSource.itemIdentifier(for: indexPath),
      case .emoji(let emojiItem) = item,
      case .system(let emoji, _) = emojiItem,
...
extension CompositionInputAccessoryView {
  fileprivate static func autocompleteLayout() -> UICollectionViewLayout {
  ...
  fileprivate func visibilityMenu() -> UIMenu {
