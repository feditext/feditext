...
final class AnnouncementView: UIView {
  ...
  private lazy var dataSource: UICollectionViewDiffableDataSource<Int, ReactionItem> = {
    let cellRegistration = UICollectionView.CellRegistration<ReactionCollectionViewCell, ReactionItem> { [weak self] in
    ...
    let dataSource = UICollectionViewDiffableDataSource<Int, ReactionItem>(collectionView: reactionsCollectionView) {
...
extension AnnouncementView {
  ...
  fileprivate func applyAnnouncementConfiguration() {
