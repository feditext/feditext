...
extension ReactionView {
  fileprivate static let meBackgroundColor = UIColor.tintColor.withAlphaComponent(0.5)
  fileprivate static let backgroundColor = UIColor.secondarySystemBackground.withAlphaComponent(0.5)
  ...
  fileprivate func applyReactionConfiguration() {
