...
final class StatusBodyView: UIView {
  ...
  var viewModel: StatusViewModel? {
    didSet {
      ...
      contentTextView.textContainer.maximumNumberOfLines =
        viewModel.shouldShowContentPreview
      ...
      if let quotedViewModel = viewModel.quoted {
        ...
        accessibilityCustomActions.append(
          .init(name: actionName) { [weak self] _ in
...
extension StatusBodyView {
  ...
  fileprivate var isContextParent: Bool {
    viewModel?.configuration.isContextParent ?? false
  }

  fileprivate var contentTextStyle: UIFont.TextStyle {
  ...
  fileprivate func updateTagView() {
  ...
  fileprivate var linkedTagViewText: AttributedString? {
  ...
  fileprivate func makeLinkedTagViewAccessibilityLabel() -> String? {
  ...
  fileprivate static var tagsViewLinkColor: UIColor = .init { traitCollection in
    if traitCollection.accessibilityContrast == .high {
      return .tintColor
    }
  ...
  /// Disabled if high contrast mode is on.
  fileprivate static var followedTagBackgroundColor: UIColor = .init { traitCollection in
    if traitCollection.accessibilityContrast == .high {
      return .clear
    }
  ...
  /// Disabled if high contrast mode is on.
  fileprivate static var tagsViewFollowedTagBackgroundColor: UIColor = .init { traitCollection in
    if traitCollection.accessibilityContrast == .high {
      return .clear
    }
