...
extension CompositionPollView {
  fileprivate static let dateComponentsFormatter: DateComponentsFormatter = {
  ...
  fileprivate static func format(expiry: CompositionViewModel.PollExpiry) -> String? {
    dateComponentsFormatter.string(from: TimeInterval(expiry.rawValue))
  }

  fileprivate var pollOptionViews: [CompositionPollOptionView] {
