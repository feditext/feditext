...
extension ReportHeaderView {
  ...
  fileprivate func update(categories: [Report.Category]) {
    ...
    for category in categories {
      let categoryButton = UIButton(
        ...
        primaryAction: UIAction(
          ...
          guard let self = self,
            let thisButton = action.sender as? UIButton
          else {
            return
          }
  ...
  fileprivate func updateCategoryButtonStack() {
  ...
  fileprivate func update(rules: [Rule]) {
    ...
    for rule in rules {
      ...
      let ruleCheckbox = UIButton(
        ...
        primaryAction: UIAction { [weak self] action in
          guard let self = self,
            let thisCheckbox = action.sender as? UIButton
          else {
            return
          }
