...
extension AccountHeaderView {
  fileprivate static let avatarDimension = CGFloat.avatarDimension * 2
  fileprivate static let missingHeaderImageSize = CGSize(width: 1, height: 1)
  fileprivate static let joinedDateFormatter: DateFormatter = {
