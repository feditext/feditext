...
extension NavigationViewModel {
  ...
  public func navigateToProfile(id: Account.Id) {
  ...
  public var hasEditProfile: Bool {
  ...
  public func navigate(pushNotification: PushNotification) {
  ...
  public var canListConversations: Bool {
