...
extension CompositionViewModel {
  public static let defaultMaxCharacters = 500
  public static let maxAttachmentCount = 4
  public static let minPollOptionCount = 2
  public static let maxPollOptionCount = 4
  ...
  public enum PollExpiry: Int, CaseIterable {
  ...
  public class PollOption: ObservableObject {
    public let id = Id()
  ...
  public func remove(pollOption: PollOption) {
    pollOptions.removeAll { $0 === pollOption }
  }

  public func attach(itemProviders: [NSItemProvider], parentViewModel: ComposeStatusViewModel) {
  ...
  public func upload(viewModel: AttachmentUploadViewModel) {
  ...
  public func update(attachmentViewModel: AttachmentViewModel) {
...
extension CompositionViewModel.PollOption {
  public static let maxCharacters = 25

  public typealias Id = UUID
}

extension CompositionViewModel {
  fileprivate static let autocompleteQueryRegularExpression = #"([@#:]\S+)\z"#
  fileprivate static let emojiOnlyAutocompleteQueryRegularExpression = #"(:\S+)\z"#

  fileprivate static func extractAutocompleteQuery(textToSelectedRange: String, emojiOnly: Bool) -> String? {
    guard
...
extension String {
  fileprivate static let urlCharacterCount = 23

  fileprivate var countShorteningIfURL: Int {
