...
extension AddIdentityViewModel {
  ...
  public func browseTapped() {
    addIdentity(kind: .browsing)
  }

  public func registrationViewModel(instance: Instance, url: URL) -> RegistrationViewModel {
...
extension AddIdentityViewModel {
  ...
  fileprivate func addIdentity(kind: AllIdentitiesService.IdentityCreation) {
